...
(without-namespace-in-synthdef
 (core/def-fx sonic-pi-fx_fverbfilt
   ...
   [room          (varlag room room_slide room_slide_curve room_slide_shape)
    ...
    hip_in        (varlag hip_in hip_in_slide hip_in_slide_curve hip_in_slide_shape)
    hip_out       (varlag hip_out hip_out_slide hip_out_slide_curve hip_out_slide_shape)
    lop_in        (varlag lop_in lop_in_slide lop_in_slide_curve lop_in_slide_shape)
    lop_out       (varlag lop_out lop_out_slide lop_out_slide_curve lop_out_slide_shape)
